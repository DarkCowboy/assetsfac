...
window.Modernizr=function(d,r,t){
    function u(a,c){
        for(var e in a)if(b[a[e]]!==t)return"pfx"==c?a[e]:!0;return!1
        }
        function k(a,b,e){
        var d=a.charAt(0).toUpperCase()+a.substr(1),g=(a+" "+c.join(d+" ")+d).split(" ");
        if("string"===typeof b||"undefined"===typeof b)b=u(g,b);
        else{
    ...
    for(var p in a)v(a,p)&&
        (j=p.toLowerCase(),l[j]=a[p](),e.push((l[j]?"":"no-")+j));b.cssText="";
...
(function(d,r,t){
    ...
    m.hashchange=d.extend(m.hashchange,{
        setup:function(){
            if(b)return!1;
            d(l.start)
            },
...
(function(d){
    function r(a,b){
        ...
        var f=a.children(),e=this.pagesContainer=this.origin=d("<div class='wowbook-origin'></div>").css({
            position:"absolute"
        }).appendTo(a);
        ...
        c.internalShadow=d(".wowbook-shadow-internal",
            e);
        c.shadowClipper=d(".wowbook-shadow-clipper",e).css({
            display:"none"
        });
        ...
        c.hardPageShadow=d("<div class='wowbook-hard-page-shadow'></div>").css({
            display:"none"
        }).appendTo(e);
...
r.prototype={
    setDimensions:function(a,b){
        ...
        var f=c.height(),e=this.origin.css({
            width:"100%",
            height:f
        });
        this.bookShadow.css({
        ...
        for(var g,j=!1,h=0,s=this.pages.length;h<s;h++)this.pages[h].css({
            width:this.pageWidth,
            height:this.pageHeight,
            left:j?0:this.pageWidth
            }),j=!j,g=d(".wowbook-page-content",this.pages[h]),k(g,this.pageWidth,
            this.pageHeight);
        ...
        this.clipBoundaries&&(e=Math.sqrt(this.pageWidth*this.pageWidth+this.pageHeight*this.pageHeight),e=[this.pageHeight-
            e,c.width(),e,0],this.origin.css("top",-e[0]),d(".wowbook-inner-clipper",c).css({
                width:"100%",
                height:e[2]-e[0],
                top:e[0]
                }),this.clipper.css({
...
insertPage:function(a,b){
    ...
    var c=d("<div class='wowbook-page'></div>").css({
        width:this.pageWidth,
        height:this.pageHeight,
        display:"none",
        position:"absolute"
...
updateBook:function(a){
    ...
    this.findPagesType();
    this.positionBookShadow();
    for(var b=!1,c,f=0,e=this.pages.length;f<e;f++)c=this.pages[f].toggleClass("wowbook-left",b).toggleClass("wowbook-right",!b).data({
        pageIndex:f,
        holded:!1
        }),c.pageIndex=f,b=!b;
    this.findSections();
...
showPage:function(a,b){
    ...
    for(var c=a-(1-a%2),f=c+1,e=this.pageWidth,g=!1,j,h,
        s=0,v=this.pages.length;s<v;s++)j=g?s:v-s,h=this.transparentPages?g?s<=c?"block":"none":s>=f?"block":"none":s===c-2||s===c||s===f||s===f+2?"block":"none",this.pages[s].data("zIndex",j).css({
        display:h,
        left:g?0:e,
        top:0,
        zIndex:j
...
foldPage:function(a,b,c,d,e){
    ...
    if(e&&e.length){
        ...
        if("l"==d||"r"==d){
            ...
            d=(c>=n.y?"t":"b")+d;
            var q=b-n.x,p=c-n.y,q=Math.atan2(p,q),n={
                x:0,
                y:(c>=n.y?0:s)-n.y
                },n=t(n,2*q);
            b=n.x+b;
        ...
        var j={
            x:d-v,
            y:l-n
            },k=t(j,c),m=k.x+b+v+0.5;
        a.css({
            clip:"rect(-1000px 2000px 2000px "+m+"px)",
        ...
        if(this.shadows&&0<k){
            ...
            this.internalShadow.css({
                display:"block",
                height:r,
                transform:"translate("+y+"px,"+u+"px) rotate("+q+"deg)",
            ...
            this.foldShadow.css({
                display:"block",
                height:r,
                transform:"translate("+(m+parseFloat(a.css("left")))+"px,"+u+"px) rotate("+q+"deg)",
                transformOrigin:v-m+"px "+(l+(r-s)/2)+"px"
                });
        ...
        this.foldGradient&&0<k?(e=2*Math.sqrt(h*h+s*s),this.foldGradientContainer.appendTo(g),this.foldGradientContainer.css({
            opacity:k,
            position:"absolute",
            left:h-d-this.foldGradientElem.width()/2,
            top:n-e/2,
            ...
            left:-b+
            this.foldGradientElem.width()/2,
            height:e
        }),this.foldGradientContainer.show()):this.foldGradientContainer.hide()
        }
    },
    ...
    if(e&&e.length){
        ...
        if(this.opts.use3d&&Modernizr.csstransforms3d){
            ...
            if(this.animating)if(g=this._animationData,this.curledPage||g.curled){
                ...
                }else Math.abs(b-g.from.x)>Math.abs(g.dx/2)&&(g.angle||(g.angle={
                from:roty,
                to:0,
                delta:-roty,
                fromx:b,
                dx:g.to.x-b
                }),roty=g.angle.from-g.angle.delta*(g.angle.fromx-b)/g.angle.dx);
            ...
            c.css({
                ...
                transformOrigin:f+"px 50%",
                display:"block",
                zIndex:1E3
            })
            }else c.css({
            transform:"skewY("+l+"rad) scaleX("+j+")",
            transformOrigin:(g?f:h-f)+"px 50%",
            display:"block",
            zIndex:1E3
        });
        !d.wowBook.support.transform&&d.wowBook.support.filters&&(b="M11="+j+", M12=0, M21="+Math.tan(l)*j+", M22=1",c.css("filter","progid:DXImageTransform.Microsoft.Matrix("+b+", sizingMethod='auto expand')"),c.css({
            marginTop:k-c.height(),
            marginLeft:a?h-c.width():0
            }));
        this.shadows&&this.hardPageShadow.css({
            display:"block",
            left:a?0:h,
            opacity:0.5*Math.abs(e/h)
            })
        }
    },
    ...
    if(e&&e.length){
        ...
        if(!a.data("foldPageBasic")){
            ...
            this.foldShadow.css({
                ...
                transform:"",
                top:0
            }).toggleClass("wowbook-shadow-fold-flipped",j);
            this.shadowContainer.css("display","block");
            var n=e.children().first();
            this.foldGradientContainer.appendTo(n).css({
                width:l,
                height:k,
                top:0,
                transform:"",
            ...
            this.foldGradientElem.css({
                left:0,
                height:k
            }).toggleClass("wowbook-fold-gradient-flipped",j)
            }
            a.data("holdedAt",{
            x:b,
            y:c
        ...
        this.shadows&&0<a?(e=h?b-m:g-b+g,this.shadowContainer.css("opacity",a),this.foldShadow.css({
            left:e,
            display:"block"
        })):this.foldShadow.css("display","none");
        a=this.calculateOpacity(2*b,2*g,this.foldGradientThreshold,50);
        this.foldGradient&&
        0<a?this.foldGradientContainer.css({
            opacity:a,
            left:h?g-b:b-l,
            display:"block"
...
releasePage:function(a,
    b,c,d){
    "number"===typeof a&&(a=this.pages[a]);
    var e=this,g=a.data("holdedAt"),j=a.data("holdedCorner");
    if(b&&g)this.animateFoldPage(a,j,g,{
        x:this.corners[j][0],
        y:this.corners[j][1]
        },function(){
        e.releasePage(a,!1,c)
        ...
        foldPageBasic:null,
        holded:!1
        }),this.clipBoundaries&&!this.zoomed&&(this.clipper.css("overflow","hidden"),
        this.clipper.children(".wowbook-inner-clipper").css("overflow","hidden")),this.shadowClipper.css("display","none"),this.internalShadow.parent().hide(),this.foldGradientContainer.hide(),this.hardPageShadow.hide(),this.resetPage(a),c&&c.length&&(this.resetPage(c),c.hide()),this.foldShadow.removeClass("wowbook-shadow-fold-flipped").css({
        transform:"",
        left:""
    }),this.foldGradientElem.removeClass("wowbook-fold-gradient-flipped").css("transform",""),this.foldGradientContainer.css("transform","").appendTo(this.pagesContainer),
...
resetPage:function(a){
    ...
    a.css(this.resetCSS).css({
        ...
        width:b,
        height:c,
        left:this.pageIsOnTheLeft(a.data("pageIndex"))?0:b
        });
    ...
    if(!this.animating&&("string"===typeof a&&"#"==a.charAt(0)&&(a=this.selectorToPage(a)),0>a&&(a=0),a>this.pages.length-1&&(a=this.pages.length-1),!this.isOnPage(a))){
        ...
        if(e){
            ...
            c?(h=h||{
                ...
                x:2*d.pageWidth,
                y:"bl"!=k?0:this.pageHeight
                }):(h=h||{
                x:this.pageWidth,
                y:0
            },c={
                x:-d.pageWidth,
                y:"br"!=k?0:this.pageHeight
                });
...
isOnPage:function(a){
    return"number"===
    typeof a&&(a===this.currentPage||a===this.otherPage(this.currentPage))
    },
backPage:function(a){
    a+=this.pageIsOnTheRight(a)?1:-1;
    return this.pages[a]
...
zoom:function(a){
    for(var b=0,c=this.pages.length;b<c;b++)if(this.pages[b].data("holdedAt"))return;a<this.zoomMin&&
    (a=this.zoomMin);
    ...
    if(a!==this.zoomLevel){
        ...
        var p=b.offset(),e=e[0]!==window?e.offset():{
            left:e.scrollLeft(),
            top:e.scrollTop()
            };
        ...
        d.wowBook.support.transform?c.css({
            transform:"scale("+a+")",
            transformOrigin:"0 0"
        }):c.css("zoom",a);
        1===this.zoomLevel?(b.unbind("mousemove.wowbook").css({
            overflow:"visible",
            left:0,
            top:0
        }),this.clipBoundaries&&this.clipper.css("overflow","hidden"),c.css({
            marginLeft:0,
            marginTop:0
        })):(this.clipBoundaries&&this.clipper.css("overflow","visible"),b.css("overflow","hidden"),
...
zoomedAt:function(a){
    if(this.zoomContentOverflowed){
        ...
        this.zoomContent.css({
            marginLeft:-c*f/adjust,
            marginTop:-g*(a/e)/adjust
            })
        }
    },
positionBookShadow:function(){
    ...
    if(b){
        ...
        c&&a?this.bookShadow.hide():this.bookShadow.css({
            left:(c?b:0)+this.pagesContainer.position().left,
            width:d?b:2*b
            })
        }
    },
...
curl:function(a,b){
    if(!this.curledPage&&!this.holdedPage){
        ...
        if(a&&!a.isCurled){
            ...
            this.animateFoldPage(a,(b?"b":"t")+(c?"l":"r"),{
                x:d,
                y:e
            },{
                x:d+this.opts.curlSize*(c?1:-1),
                y:e+this.opts.curlSize*(!b?1:-1)
                },null,!1,void 0,400)
            }
        }
},
...
initThumbnails:function(){
    ...
    if("left"==a||"right"==a)this.opts.thumbnailsVertical=!0,"right"==a&&this.thumbnailsContainer.css({
        position:"absolute",
        left:"auto",
        right:"0px"
    });
    if("top"==a||"bottom"==a)this.opts.thumbnailsVertical=!1,"bottom"==a&&this.thumbnailsContainer.css({
        position:"absolute",
        top:"auto",
        bottom:"0px"
    });
...
createThumbnail:function(a,b){
    ...
    if(c){
        ...
        var f=d('<li class="wowbook-thumbnail"><div class="wowbook-overlay">').addClass(this.pageIsOnTheLeft(a)?"wowbook-left":"wowbook-right").css({
            width:b.width,
            height:b.height
            });
...
showThumbnails:function(){
    (!this.thumbnails||
        !this.thumbnails.length)&&this.createThumbnails();
...
var l=d.browser.msie&&9>d.browser.version?1:0,m={
    thin:2-l,
    medium:4-l,
    thick:6-l
    }
