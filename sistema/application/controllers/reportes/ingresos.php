...
class Ingresos extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->data['reportes_tipo'] = 'Reporte de Ingresos';
        $this->data['contraparte'] = 'Deudor';
    }
    ...
    public function por_fecha() {
        ...
        $this->data['sub_menu'] = 'reporte_egresos';
        $this->data['sub_menu_interno'] = 'ingreso_por_fecha';
        if ($this->centinela) {
            if (!$this->rol) {
                show_404();
            }
            if ($this->input->post()) {
                ...
                switch ($form['periodo']) {
                    case 'o': //Otro
                        ...
                        $form['query'] = '  id_t_operacion = 3 and DATE(fecha_pago) BETWEEN \'' . $form['desde'] . '\' AND \'' . $form['hasta'] . '\' ';
                    ...
                    case 'a': //Mes actual
                        ...
                        unset($form['periodo']);
                        unset($form['tipoBusq']);
                        $form['query'] = " id_t_operacion = 3 and  Date_format( fecha_pago, '%m' ) = Date_format( NOW( ) , '%m' )";
                        $this->data['reporte'] = $this->reportes_model->reporte_por_fecha($form);
                        $this->data['titulo_reporte'] = 'Por Fecha Mes Actual';
                        break;
                    case 'n': //Mes anterior
                        $form['query'] = " id_t_operacion = 3 and  Date_format( fecha_pago, '%m' ) = Date_format( DATE_SUB( NOW( ) , INTERVAL 1 MONTH ) , '%m' )";
                        $this->data['reporte'] = $this->reportes_model->reporte_por_fecha($form);
                        $this->data['titulo_reporte'] = 'Por Fecha Mes Anterior';
                        break;
                    case 'u': //Últimos 12 meses
                        $form['query'] = ' id_t_operacion = 3 and  `fecha_pago` BETWEEN DATE_SUB( NOW( ) , INTERVAL 12 MONTH ) AND NOW( )';
                        $this->data['reporte'] = $this->reportes_model->reporte_por_fecha($form);
            ...
            $this->data['fecha'] = '0';
            $this->data['action'] = './reportes/ingresos/por_fecha';
    ...
    public function por_banco() {
        $this->data['menu'] = 'reportes';
        $this->data['sub_menu'] = 'reporte_egresos';
        $this->data['sub_menu_interno'] = 'ingreso_por_banco';
        if ($this->centinela) {
            if (!$this->rol) {
                show_404();
            }
            ...
            $this->data['action'] = './reportes/ingresos/por_banco';
    ...
    public function por_beneficiario() {
        $this->data['menu'] = 'reportes';
        $this->data['sub_menu'] = 'reporte_egresos';
        $this->data['sub_menu_interno'] = 'ingreso_por_beneficiario';
        if ($this->centinela) {
            if (!$this->rol) {
                show_404();
            }
            ...
            $this->data['action'] = './reportes/ingresos/por_beneficiario';
    ...
    public function por_instrumento() {
        $this->data['menu'] = 'reportes';
        $this->data['sub_menu'] = 'reporte_egresos';
        $this->data['sub_menu_interno'] = 'ingreso_por_instrumento';
        if ($this->centinela) {
            if (!$this->rol) {
                show_404();
            }
            ...
            $this->data['action'] = './reportes/ingresos/por_instrumento';
    ...
    public function por_moneda() {
        $this->data['menu'] = 'reportes';
        $this->data['sub_menu'] = 'reporte_egresos';
        $this->data['sub_menu_interno'] = 'ingreso_por_moneda';
        if ($this->centinela) {
            if (!$this->rol) {
                show_404();
            }
            ...
            $this->data['action'] = './reportes/ingresos/por_moneda';
