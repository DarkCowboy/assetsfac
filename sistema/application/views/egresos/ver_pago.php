    ...
    <div id="main">
        ...
        <div id="middle">
            <div id="center-column" style="float: left; margin: 0 auto; width: 750px !important">
                <div class="top-bar">
                    <h1 style="text-align: center;">Pago para <?= ucwords($instruccion['nombre_proveedor']); ?></h1>
                </div><br/><br/>
                <?
                ...
                <? if ($instruccion['t_instrumento'] == 'Cheque') { ?>
                    <? if ($instruccion['nombre_imagen_cheque']) { ?>
                        <? if (strpos(strtolower(trim($instruccion['nombre_banco'])), 'balboa')) { ?>

                            <div style="position: relative; background: url('./images/cheques/vista_<?= $instruccion['nombre_imagen_cheque']; ?>') no-repeat; width: 614px; height: 297px; margin:10px auto;">
                                <?
                        ...
                        <tbody style="text-align: center;">
                            ...
                            <tr>
                                <td colspan="3" rowspan="6" style="border: 1px solid black; text-align: justify; vertical-align: text-top; padding: 5px;">
                                    <?= 'Detalles del concepto: ' . $instruccion['detalles_concepto'] . ' <br/> Soporte: ' . $instruccion['t_documento'] ?>
                                </td>
