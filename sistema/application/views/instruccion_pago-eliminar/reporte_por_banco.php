<html>
    ...
    <body>
        <div class="cuerpo">
            ...
            <div><b>Reporte por Bancos</b></div>
            ...
            <div class="contenido">
                <table class="tabla">
                    ...
                    <? foreach ($reporte as $row) { ?>
                        <?
                        if ($row['t_instrumento'] != 'Efectivo') {
                            if ($nombre_banco != $row['nombre_banco']) {
                                ...
                                <td colspan="8" class = "contenido_td" style = "width: 7px;"><b>' . $row['nombre_banco'] . '</b></td>
                                </tr>';
                                $cliente_fin = true;
                                $sub_tot_tot = 0;
                            }
