...
function resultadoEjercicio2(campo){
    ...
    $('#txtAumDismCapContable2').attr('value',roundNumber(parseFloat(aum_dism_cap_contable2),2));
    $('#txtFFBenefNetoDespNoUsu').attr('value',$('#txtBenefDespNoUsuales2').attr('value'));
}
...
function resultadoEjercicio3(campo){
    ...
    $('#txtAumDismCapContable3').attr('value',roundNumber(parseFloat(aum_dism_cap_contable3),2));
    $('#txtFFBenefNetoDespNoUsu1').attr('value',$('#txtBenefDespNoUsuales3').attr('value'));
}
...
{   
    ImpResta1_Year1 = -1 * restaDosValores_Retorna($('#txtimpuestospagar').attr('value'), $('#txtimpuestospagar2').attr('value'));
    //Asignamos el resultado
    $('#txtImpPagarReten0').attr('value',ImpResta1_Year1);
    
    ImpResta1_Year2 = -1 * restaDosValores_Retorna($('#txtimpuestospagar2').attr('value'), $('#txtimpuestospagar3').attr('value'));
    //Asignamos el resultado
...
function setProductividad_Empresa()
{
    ...
    var este = parseFloat($('#txtTotalActFijo2').attr('value'));
    ...
    ResultadoDivCD2 = divideDosValores_Retorna($('#txtGenerAbsobOper0').attr('value'), TotalOperaciones2);
...
function setVerificaciones(){
    ...
    $('#verifica1').html(valida1);
    $('#verifica2').html(valida2);
    $('#verifica3').html(valida3);
}
