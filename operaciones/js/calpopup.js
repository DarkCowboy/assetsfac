...
function Calendar() {
	...
	this.months = "Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Ddiciembre".split(" ");
...
Calendar.prototype.show = function(e, target, dateFormat, dateFrom, dateTo, menuYearFrom, menuYearTo){
	...
	this.menuYearFrom = menuYearFrom || this.year - 12;
