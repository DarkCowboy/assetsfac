<html>
    ...
    <body>
        <div class="cuerpo">
            ...
            <div><b>Reporte Cliente / Vencimiento</b></div>
                ...
                <table class="tabla">
                    ...
                    <? foreach ($operaciones as $row) { ?>
                        <? if ($row['status'] == 2 or $row['status'] == 6) { ?>
                            ...
                            <?
                            if ($cliente_nombre != $row['nombre_razon_social_pn_pj']) {
                                ...
                                $cliente_nombre = $row['nombre_razon_social_pn_pj'];
                                echo'<tr class = "titulo_tabla">
                                <td colspan="14" class = "contenido_td" style = "width: 7px;"><b>' . $row['nombre_razon_social_pn_pj'] . '</b></td>
                                </tr>';
                                $cliente_fin = true;
                            }
                            ?>
