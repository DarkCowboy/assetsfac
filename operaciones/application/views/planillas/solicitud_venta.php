            ...
            <div class="contenido">
                ...
                <table class="tabla" style="border: none;">
                    ...
                    <tr>
                        ...
                        <td class="sub_titulo_tabla" style="width: 80px;">F. DE EMISION</td>
                        <td class="sub_titulo_tabla" style="width: 70px;">F. DE VCTO</td>
                        <td class="sub_titulo_tabla" style="width: 50px;">NOMINAL</td>
                ...
                <table class="tabla" style="border: none;">
                    ...
                    <tr>
                        <td class="contenido_justificado" style="font-size: 12px;" >
                            ...
                            de conformidad con lo previsto en el Contrato Marco suscrito entre las partes y <b>ASSETS FACTORING INC.</b>, 
