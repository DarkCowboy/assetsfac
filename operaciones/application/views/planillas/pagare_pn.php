    ...
    <body>
        <div class="cuerpo" style="text-align: justify; font-family: Arial; font-size: 11pt; line-height: 18px;">
            ...
            <p>
                ...
                nombre y representaci&oacute;n en adelante EL <b>CODEUDOR SOLIDARIO</b> se obligan incondicionalmente a pagar a la orden de  <b>ASSETS FACTORING INC.</b>, 
                sociedad an&oacute;nima organizada de
                ...
                (Mercantil), del Registro P&uacute;blico, con domicilio en la Ciudad de Panam&aacute;, Rep&uacute;blica de Panam&aacute;, en adelante EL ACREEDOR, la suma de 
                <b><?
                    $V = new EnLetras();
                    echo strtoupper($V->ValorEnLetras(($planilla['monto_solicitud_aprobado']), 'Dolares'));
                    ?>
                    (USD. <? echo number_format($planilla['monto_solicitud_aprobado'], 2, ',', '.'); ?>)</b>  moneda de curso legal 
