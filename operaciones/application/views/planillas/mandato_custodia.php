<html>
    ...
    <body>
        <div class="cuerpo">
            ...
            <br/>
            <p>
                Entre los suscritos a saber <b>WILLIAN DIONICIO RAM&Iacute;UREZ MONTES</b>, var&oacute;n, Venezolano, mayor de edad, con pasaporte n&uacute;mero 054896299,
                actuando en su condici&oacute;n de Secretario y Representante Legal de ASSETS FACTORING INC.  sociedad an&oacute;nima organizada de conformidad con las leyes de 
            ...
            <p>
                ...
                ?>
                (US$ <?= number_format($solicitud['monto_solicitud'], '2', ',', '.'); ?>),
            ...
            <table class="tabla">
                <tr>
                    <td class="titulo_tabla" colspan="8">RELACI&Oacute;N DE FACTURAS</td>
                </tr>
                <tr>
                    <td class="sub_titulo_tabla">NUMERO</td>
                    <td class="sub_titulo_tabla">NUMERO DE FACTURA</td>
                    <td class="sub_titulo_tabla">DEUDOR</td>
                    <td class="sub_titulo_tabla">RIF / RUC</td>
                    <td class="sub_titulo_tabla">FECHA DE EMISION</td>
                    <td class="sub_titulo_tabla">FECHA DE VCTO</td>
            ...
            <p>
                ...
                <b><?
                $equivalente = $solicitud['monto_solicitud_aprobado'] * $solicitud['porcentaje_compra'] / 100;
            ...
            <p>
                ...
                ?>. Para lo cual el <b>CLIENTE</b> deber&aacute; realizar todas las diligencias
            ...
            <b><p style="text-align: center;">
                    Por ASSETS FACTORING INC. 
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Por <?= strtoupper($solicitud['nom_rz_pj']); ?>.
            </p></b>
