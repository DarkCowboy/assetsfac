...
<script type="text/javascript" >
    ...
    <body>
        <div class="wrap">
            <form action="./clientes/aceptar_pagare_pn/<?= $id_solicitud; ?>" id="validate-form" onSubmit="return validator(this);" method="post">
                <div class="titulo">
                    PROCESAR PAGARE
                </div>
                <div class="contenido">
...
<!--                            <h4>Fecha de Aprobacion:</h4> 
                            ...
                            <input  type="text" name="monto_solicitud_aprobado" value="<?= @$planilla["monto_solicitud"]; ?>" style="width: 100%;" data-required="true" onkeypress="return permite(event, 'num')" />
