                ...
                <div class="contenido">
                    <div class="bloque_izquierdo">
                        <div class="contenido_marcos">
                            ...
                            <input value="<?= 'ASSC' . date(Y) . '-' . $num_control; ?>" type="text" name="n_operacion" />

                            <h4>Modalidad:</h4> 
                            <input value="<?= @$planilla['modalidad']; ?>" type="text" name="modalidad" style="width: 100%;"/>
                                    ...
                                    <td>
                                        <select name="nom_acc_resumen[]" style="width: 100%;">
                                            ...
                                            <? foreach (@$planilla['junta_directiva'] as $row) { ?>
                                                <option value="<?= $row['nombres_dir'] ?>"><?= $row['nombres_dir'] ?></option> 
                                            <? } ?>
                                        </select>
                                    </td>
                                    <td>
