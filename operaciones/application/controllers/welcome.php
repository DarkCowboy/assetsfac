                    ...
                    <body>
                        <div style="width:100%;">
                            ...
                            "info@assetsfactoring.com" con el asunto "Pago de Operacion ' . $row['n_operacion'] . '"</p>
                                ...
                                <p style="text-align:justify;">En el Caso de que desee realizar el refinanciamiento de la operacion usted debera ingresar en
                                su <b>Area de Cliente</b>, solicitar <b>Refinanciamiento de Ventas</b> mediante el menu de opciones que aparece en esta area.</p>
                            ...
                            <body>
                                <div style="width:100%;">
                                    ...
                                    "info@assetsfactoring.com" con el asunto "Pago de Operacion ' . $row['n_operacion'] . '"</p>
                                        ...
                                        <p style="text-align:justify;">En el Caso de que desee realizar el refinanciamiento de la operacion usted debera ingresar en
                                        su <b>Area de Cliente</b>, solicitar <b>Refinanciamiento de Pagare</b> mediante el menu de opciones que aparece en esta area.</p>
                            ...
                            <body>
                                <div style="width:100%;">
                                    ...
                                    "info@assetsfactoring.com" con el asunto "Pago de Operacion ' . $row['n_operacion'] . '"</p>
                                        ...
                                        <p style="text-align:justify;">En el Caso de que desee realizar el refinanciamiento de la operacion usted debera ingresar en
                                        su <b>Area de Cliente</b>, solicitar <b>Refinanciamiento de Prestamo</b> mediante el menu de opciones que aparece en esta area.</p>
