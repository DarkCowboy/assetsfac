...
this.oApi={
    ...
    _fnCreateCookie:function(a,b,c,d,e){
        ...
        var c=X.location.pathname.split("http://aqvatarius.com/"),a=a+"_"+c.pop().replace(/[\/:]/g,"").toLowerCase(),g;
        null!==e?(g="function"===typeof h.parseJSON?h.parseJSON(b):eval("("+b+")"),
            b=e(a,g,f.toGMTString(),c.join("http://aqvatarius.com/")+"/")):b=a+"="+encodeURIComponent(b)+"; expires="+f.toGMTString()+"; path="+c.join("http://aqvatarius.com/")+"/";
        a=l.cookie.split(";");
        e=b.split(";")[0].length;
        f=[];
...
_fnReadCookie:function(a){
    for(var b=X.location.pathname.split("http://aqvatarius.com/"),a=a+"_"+b[b.length-1].replace(/[\/:]/g,"").toLowerCase()+"=",b=l.cookie.split(";"),c=0;c<b.length;c++){
...
oLanguage:{
    ...
    sSearch:"Buscar:",
    sUrl:"",
    sZeroRecords:"No se encontro ningun registro asociado a su busqueda"
},
