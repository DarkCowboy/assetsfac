    ...
    <div class="content">
        ...
        <div class="workplace" style="">
            <div style="width: 100%;">
                ...
                <form method="post" action="./cupos/nueva_solicitud/" class="form" id="validate-form" onSubmit="return validator(this);">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6" style="">
                            ...
                            <div class="block-fluid">                        
                                <div class="control-group">
                                    ...
                                    <? if ($rollover != null) { ?>
                                        <input type="hidden" name="rollover" id="rollover" value="<?= $rollover; ?>" />  
                                    <? } ?>
                                    <div class="row-form">
                                        <div class="span3">Monto de la Solicitud:</div>                 
                                        <div class="span9">
                                            <input type="text" class="monto" name="monto_solicitud" id="monto_solicitud" placeholder="Ingrese el monto con el siguiente formato ejemplo: 1500.00" data-required="true" value="<?= @$solicitud['monto_solicitud'] ?>" onkeypress="return permite(event, 'numpunto')"/>  
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="row-form">
                        ...
                        <div class="span6" style="">
                            <div class="head">
                                <div class="isw-documents"></div>
                                <h1>Requisitos para la solicitud de Cupo</h1>
                                <div class="clear"></div>
                            </div>
                            <div class="block-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="head" style="width: 226px;">
                                <button type="submit" class="btn btn-block">Enviar Solicitud de Cupo</button>
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
