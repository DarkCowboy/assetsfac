...
<html>
    ...
    <body style="font-family: Verdana !important;">
        ...
        <div style="position: absolute; top: 80px; left: 70px; font-size: 8.5px; text-align: center; border: 1px solid white;">
            <?= strtoupper($instruccion['nombre_proveedor']); ?>
        </div>
        <div style="position: absolute; top: 100px; left: 80px; font-size: 8.5px; text-align: center; border: 1px solid white;">
            <?= $monto ?>
        </div>
        ...
        <div style="position: absolute; top: 150px; left: 270px; width: 50px; font-size: 8.5px; text-align: center; border: 1px solid white;">
            <?= $fecha[4] ?>
        </div>
<? // debug(explode(' ',fecha($instruccion['fecha_procesado'])), false); ?>
    </body>    
</html>