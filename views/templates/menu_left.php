        ...
        <nav id="nav" class="menu_left ">
            <ul class="li_menu_left menu collapsible shadow-bottom">
                ...
                <? if ($rol == 10 or $rol == 0 or $rol == 1 or $rol == 2) { ?>
                    <li class="ul_left" style="<?= $menu == 'egresos' ? 'background:#B8B8B8;' : '' ?>">
                        ...
                        <ul style="display: <?= $menu == 'egresos' ? 'block !important' : 'none' ?>;" class="sub">
                            <li style="<?= $sub_menu == 'crear_instruccion' ? 'background:#284860; !important' : '' ?>;"><a href="./egresos/crear_instruccion">Crear Instruccion</a></li>
                            <li style="<?= $sub_menu == 'editar_instruccion' ? 'background:#284860; !important' : '' ?>;"><a href="./egresos/imprimir_editar">Editar Instrucciones</a></li>
                            <li style="<?= $sub_menu == 'operaciones_ms' ? 'background:#284860; !important' : '' ?>;"><a href="./egresos/operaciones_ms">Operaciones MS</a></li>
                            <li style="<?= $sub_menu == 'pagos_procesar' ? 'background:#284860; !important' : '' ?>;"><a href="./egresos/pagos_procesar">Procesar Pagos</a></li>
                            <!--<li style="<?= $sub_menu == 'cheques_imprimir' ? 'background:#284860; !important' : '' ?>;"><a href="./egresos/cheques_imprimir">Cheques por imprimir</a></li>-->
                ...
                <? } ?>
                    ...
                    <? if ($rol == 10 or $rol == 0 or $rol == 1 or $rol == 2) { ?>
                    <li class="ul_left" style="<?= $menu == 'cheques' ? 'background:#B8B8B8;' : '' ?>">
                        <a class="<?= $menu == 'cheques' ? 'active-icon active !important' : 'non-active-icon' ?>" href="javascript:void(0);"><img  style="float: left; width: 34px;" src="images/general/cheque_icon.png">Cheques<span class="arrow"></span></a>
                        <ul style="display: <?= $menu == 'cheques' ? 'block !important' : 'none' ?>;" class="sub">
                            <li style="<?= $sub_menu == 'cheques_imprimir' ? 'background:#284860; !important' : '' ?>;"><a href="./egresos/cheques_imprimir">Cheques por imprimir</a></li>
                        </ul>
                    </li>
                <? } ?>
