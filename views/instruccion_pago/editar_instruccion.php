...
<? } ?>\n\
                ...
                $('#beneficiario').append('<tr>\n\
                            ...
                            <tr class="bg">
                                <td class="first"><strong>N&deg; de factura</strong></td>
                                <td class="last"><input name="n_factura" value="<?= $instruccion['n_factura'] ?>"  class="text" type="text" data-required="true"></td>
                            </tr>
