<htm>
    ...
    <body>
        ...
        <table  class="tabla">
            ...
            <tr>
                <td class="td">&nbsp;&nbsp;&nbsp;<?= $instruccion['pre_id_number']; ?></td>
            ...
            <tr>
                <td class="td">&nbsp;&nbsp;&nbsp;N&deg; DE FACTURA</td>
                <td class="td"><?= $instruccion['n_factura']; ?></td>
            </tr>
            <tr class="td_oscuro">
            ...
            <tr>
                <td style="text-align: center;">ELABORADO POR 
                <? foreach($usuarios as $row) { if (@$row['creada'] == '1'){ echo strtoupper(@$row['first_name'].' '.@$row['last_name']); }} ?></td>
