<html>
    ...
    <body>
        <div class="cuerpo">
            ...
            <div><b>Reporte por Beneficiario</b></div>
            ...
            <div class="contenido">
                <table class="tabla">
                    ...
                    <? foreach ($reporte as $row) { ?>
                            ...
                            <?
                            if ($nombre_proveedor != $row['nombre_proveedor'] or $moneda != $row['moneda']) {
                                ...
                                <td colspan="8" class = "contenido_td" style = "width: 7px;"><b>' . $row['nombre_proveedor'] . '('.$row['moneda'].')'.'</b></td>
                                </tr>';
                                $cliente_fin = true;
                                $sub_tot_tot=0;
                            }
