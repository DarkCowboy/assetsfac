                    ...
                    <table class="table_main_form">
                        <tbody>
                            ...
                            <tr class="bg">
                                ...
                                <td class="last"><input name="telefonos_proveedor" class="text imput_form1" id="telefonos_proveedor" type="text"  ></td>
                            </tr>
                            <tr class="bg">
                                <td class="first" width="172">Direccion del Beneficiario</td>
                                <td class="last"><input name="direccion_proveedor" class="text imput_form1" id="direccion_proveedor" type="text"  ></td>
                            </tr>
                            <tr>
