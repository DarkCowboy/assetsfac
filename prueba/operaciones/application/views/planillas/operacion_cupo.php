        ...
        <div class="contenido">
            ...
            <div class="header_solicitud">
                <div>
                    ...
                    <div class="titulo">PROPUESTA DE OPERACION DE CUPO</div>
                </div>
                <div>
            ...
            <table class="tabla">
                <tr>
                    <td class="titulo_tabla" colspan="3">DATOS DE LA SOLICITUD DE CUPO</td>
                </tr>
                <tr>
            ...
            <table class="tabla">
                ...
                <tr>
                    ...
                    <td class="sub_titulo_tabla" style="border:1px solid #c9c9c9; width: 15%; text-align: center;"><?= ucwords(@$res_finan_acc['nom_acc_resumen'][0]); ?></td>
                    <td class="sub_titulo_tabla" style="border:1px solid #c9c9c9; width: 15%; text-align: center;"><?= ucwords(@$res_finan_acc['nom_acc_resumen'][1]); ?></td>
                </tr>
                <tr>
