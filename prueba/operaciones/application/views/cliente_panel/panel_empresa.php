                                                ...
                                                <? if ($row['tipo_solicitud'] == 2) { ?>
                                                    <? if ($row['status'] == 2 or $row['status'] == 6) { ?>
                                                        <table style="width: 100%; font-size: 11px; line-height: 18px;">
                                                            ...
                                                            <tr>
                                                                <td class="titulo_tabla" style="text-align: left;" colspan="14">Seleccione la Factura a cancelar</td>
                                                            </tr>
                                                            <tr>
...
//                                                                        debug($data_fact, false);
                                                    ...
                                                    <? if ($row['status'] == 2 or $row['status'] == 6) { ?>
                                                        ...
                                                        <table style="width: 100%; font-size: 11px; line-height: 18px;">
                                                            ...
                                                            <tr style="text-align: center; background: #9C9C8B; color: white; font-weight: bold;">
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Nominal</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">F. Liqui.</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">F. Vto.</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Plazo</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Precio</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Pagado</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Dif.</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Mora/dias</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Dif. Act.</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Total</td>
                                                                <td class="sub_titulo_tabla" style="width: 7px; text-align: center;">Status</td>
                                                            </tr>
                                                            <?
                                                            $tot_nom = 0;
                                                            $tot_pag = 0;
                                                            ...
                                                            <? if ($row['status'] == 2 or $row['status'] == 6) { ?>
                                                                ...
                                                                $tot_tot = $tot_tot + $tot;
                                                                ?>
                                                                <tr style="<?= $row['status'] == '2' ? 'color:black;' : 'color:red;' ?>  <?= $row['pause'] == 1 ? 'background:#ffff7e;' : '' ?>"  >
                                        ...
                                        <table class="tabla" style="margin-top: 12px;">
                                            ...
                                            <tr>
                                                <td class="contenido_td">
                                                    <a target="_blank" href="./clientes/descarga_ficha_pj/<?= $data_empresa['id_cliente'] ?>">
                                                ...
                                                <td class="contenido_td" style="border-left: 1px solid #9C9C9C;">
                                                    <? foreach ($data_empresa['junta_directiva'] as $row) { ?>
                                                        <a  target="_blank" href="./clientes/descarga_ficha_pn_pj/<?= $row['id_jun_directiva'] ?>">
                                        ...
                                        <table class="tabla">
                                            ...
                                            foreach (array_reverse($data_cupos) as $row) {
                                                ...
                                                <tr <?= $class == 0 ? '' : 'style="background:lightcyan;"'; ?>>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <div>
                                                            <a target="_blank" href="./clientes/planilla_solicitud_cupo/<?= $row['id_solicitud']; ?>">
                                                                <img src="images/general/descargar.png" />
                                                            </a>
                                                        </div>
                                                    </td>
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <? if ($row['status'] == 1 or $row['status'] == 2 or $row['status'] == 5 or $row['status'] == 6) { ?>
                                                            <div>
                                                                <a  target="_blank" href="./clientes/planilla_operacion_cupo/<?= $row['id_solicitud']; ?>">
                                                                    <img src="images/general/descargar.png" />
                                                                </a>
                                                            </div>
                                                        <? } ?>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <? if ($row['status'] == 2 or $row['status'] == 5 or $row['status'] == 6) { ?>
                                                            <div>
                                                                <a target="_blank" href="./clientes/descargar_contrato/<?= $row['id_pj']; ?>/<?= $row['id_solicitud']; ?>">
                                                                    <img src="images/general/descargar.png" />
                                                                </a>
                                                            </div>
                                                        <? } ?>
                                                    ...
                                                    <td class="contenido_td">
                                                        ...
                                                        <? } ?>
                                                            <?  if ($row['status'] == 0 or $row['status'] == 3 or $row['status'] == 1) { ?>

                                                        <br/><img class="eliminar" style='list-style: none; cursor: pointer;' id="<?= $row['id_solicitud']; ?>" src="images/general/eliminarop.png" />
                                        ...
                                        <table class="tabla">
                                            ...
                                            foreach (array_reverse($data_ventas) as $row) {
                                                ...
                                                <tr <?= $class == 0 ? '' : 'style="background:lightcyan;"'; ?>>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <div>
                                                            <a target="_blank" href="./clientes/solicitud_de_venta_planilla/<?= $row['id_solicitud']; ?>">
                                                                <img src="images/general/descargar.png" />
                                                            </a>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <? if ($row['status'] == 1 or $row['status'] == 2 or $row['status'] == 5 or $row['status'] == 6 or $row['status'] == 7) { ?>
                                                            <div>
                                                                <a target="_blank" href="./clientes/planilla_operacion_venta/<?= $row['id_solicitud']; ?>">
                                                                    <img src="images/general/descargar.png" />
                                                                </a>
                                                            </div>
                                                        <? } ?>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <? if ($row['status'] == 2 or $row['status'] == 5 or $row['status'] == 6 or $row['status'] == 7) { ?>
                                                            ...
                                                            <div>
                                                                <a target="_blank" href="./clientes/descargar_giro/<?= $row['id_pj']; ?>/<?= $row['id_solicitud']; ?>">
                                                                    <img src="images/general/descargar.png" />
                                                                </a>
                                                            </div>
                                                    ...
                                                    <td class="contenido_td">
                                                        ...
                                                        <div style="" class="menu_accion">
                                                            <? if ($row['status'] != 5) { ?>
                                                                <ul class="menu collapsible shadow-bottom" style="padding: 0 0 0 2px !important; list-style: none;">
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="images/general/seleccionar.png" class="acciones" /></a>
                                                                        <ul class="sub" style="padding: 0 0 0 2px !important; list-style: none;">
                                                                            <? if ($row['status'] == 0 or $row['status'] == 1) { ?>

                                                                                <li style="margin: 3px 0px;">
                                                                                    <a href="clientes/rechazar/<?= $row['id_solicitud']; ?>/<?= $row['id_cliente']; ?>">
                                                                                        <img src="images/general/rechazarop.png" />
                                                                                    </a>
                                                                                </li>
                                                                            ...
                                                                            <? } if ($row['status'] == 0) { ?>
                                                                                ...
                                                                                <li style="margin: 3px 0px;">
                                                                                    <img  onclick="$.fancybox({type: 'iframe', href: './clientes/procesar_cupo/<?= $row['id_solicitud']; ?>'});"  src="images/general/procesarop.png" />
                                                                                </li>

                                                                            <? } if ($row['status'] == 2 or $row['status'] == 6) { ?>

                                                                                <? if ($row['pause']) { ?>
                <!--                                                                                    <a href="./pausa_operacion/reanudar/<?= $row['id_solicitud']; ?>">
                                                                                                        <li style="margin: 3px 0px;"><img src="images/general/reanudarop.png" /></li>
                                                                                                    </a>-->
                                                                                <? } else { ?>
                <!--                                                                                    <a href="./pausa_operacion/<?= $row['id_solicitud']; ?>">
                                                                                                        <li style="margin: 3px 0px;"><img src="images/general/pausarop.png" /></li>
                                                                                                    </a>-->
                                                                                <? } ?>
                                                                            ...
                                                                            <? } if ($row['status'] == 2 or $row['status'] == 6) { ?>
                                                                                ...
                                                                                <li style="margin: 3px 0px;">
                                                                                    <img onclick="$.fancybox({type: 'iframe', 'height': 450, 'autoSize': false, href: './comprobar_pago/<?= $row['id_solicitud'] . '/' . $row['id_cliente']; ?>'});" class="fin" src="images/general/finalizarop.png" />
                                                                                </li>

                                                                            <? } if ($row['status'] == 7 or $row['status'] == 2 or $row['status'] == 6) { ?>
                                                                                                                                                                <!--<li style="margin: 3px 0px;"><img src="images/general/enviarpag.png" /></li>-->
                                                                                <a href="./clientes/email_convenio/<?= $row['id_solicitud'] . '/' . $row['id_cliente']; ?>">
                                                                                    <li style="margin: 3px 0px;"><img src="images/general/enviarconv.png" /></li>
                                                                                </a>

                                                                            <? } if ($row['status'] == 0 or $row['status'] == 3 or $row['status'] == 1) { ?>

                                                                                <li style="margin: 3px 0px;"><img class="eliminar" style='cursor: pointer;' id="<?= $row['id_solicitud']; ?>" src="images/general/eliminarop.png" /></li>

                                                                            <? } if ($row['status'] == 0 or $row['status'] == 3 or $row['status'] == 1) { ?>

                                                                                <!--<li style="margin: 3px 0px;"><img src="images/general/definirop.png" /></li>-->

                                                                            <? } if ($row['status'] == 1) { ?>

                                                                                <li style="margin: 3px 0px;"><img onclick="$.fancybox({type: 'iframe', 'height': 550, 'width': 900, 'autoSize': false, href: './clientes/aceptar_solicitud_v/<?= $row['id_solicitud']; ?>'});" src="images/general/aceptarop.png" /></li>

                                                                            <? } if ($row['status'] == 7) { ?>

                                                                                <li style="margin: 3px 0px;"><img class="activar_operacion" fecha_activacion ="<?= date('Y-m-d'); ?>" href= "clientes/activar_solicitud/<?= $row['id_solicitud']; ?>/<?= date('Y-m-d'); ?>" src="images/general/activarop.png" /></li>
                                                                            <? } if ($row['status'] == 1) { ?>

                                                                                <li style="margin: 3px 0px;"><img onclick="$.fancybox({type: 'iframe', href: './clientes/procesar_cupo/<?= $row['id_solicitud']; ?>'});" src="images/general/editarop.png" /></li>
                                                                            <? } if ($row['status'] == 1) { ?>

                                                                                <li style="margin: 3px 0px;"><img onclick="$.fancybox({type: 'iframe', href: './clientes/editar_facturas/<?= $row['id_solicitud']; ?>'});" src="images/general/editarfac.png" /></li>
                                                                            <? } ?>
                                                                        </ul>
                                                                    </li>
                                                                </ul>
                                        ...
                                        <table class="tabla">
                                            ...
                                            foreach (array_reverse($data_pagares) as $row) {
                                                ...
                                                <tr <?= $class == 0 ? '' : 'style="background:lightcyan;"'; ?>>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <div>
                                                            <a target="_blank" href="./clientes/planilla_solicitud_pagare/<?= $row['id_solicitud']; ?>">
                                                                <img src="images/general/descargar.png" />
                                                            </a>
                                                        </div>
                                                    </td>
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <? if ($row['status'] == 1 or $row['status'] == 2 or $row['status'] == 5 or $row['status'] == 6 or $row['status'] == 7) { ?>
                                                            <div>
                                                                <a target="_blank" href="./clientes/planilla_operacion_pagare/<?= $row['id_solicitud']; ?>">
                                                                    <img src="images/general/descargar.png" />
                                                                </a>
                                                            </div>
                                                        <? } ?>
                                                    ...
                                                    <td class="contenido_td" style="border-right: solid 1px #666;">
                                                        <? if ($row['status'] == 2 or $row['status'] == 5 or $row['status'] == 6 or $row['status'] == 7) { ?>
                                                            <div>
                                                                <a target="_blank" href="./clientes/descargar_pagare/<?= $row['id_pj']; ?>/<?= $row['id_solicitud']; ?>">
                                                                    <img src="images/general/descargar.png" />
                                                                </a>
                                                            </div>
                                                        <? } ?>
                                                    ...
                                                    <td class="contenido_td">
                                                        ...
                                                        <? if ($row['status'] == 2) { ?>
                                                            <a href="./clientes/email_pagare_pj/<?= $row['id_solicitud'] . '/' . $row['id_cliente']; ?>">
                                ...
                                <div id="tab-7" class="tab-content" style="min-height: 100px;">
                                    ...
                                    <hr>
                                    <a target="_blank" href="./clientes/descargar_reclasificacion/<?= $data_empresa['id_pj']; ?>" style="margin-left: 45%;"><img src="images/general/descargar.png"></a>
                                    <hr>
            ...
            <div id="cargando" style="width: 100%">
                <div style="display: block;    margin: 27px auto;    overflow: hidden;    width: 318px;">
