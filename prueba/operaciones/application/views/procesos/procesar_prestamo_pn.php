...
<script type="text/javascript" >
    ...
    <body>
        <div class="wrap">
            <form action="./clientes/procesar_prestamo_pn" method="post">
                <div class="titulo">
                    PROCESAR SOLICITUD
                </div>
                <?
                        ...
                        <div class="contenido_marcos">
                            ...
                            <textarea name="ana_comentarios" style="width: 100%;height: 124px;">
                                ...
                                if ($planilla['ana_comentarios'] == '') {
                                    if ($rollover) {
                                        echo 'Esta Operacion cancela la operacion anterior N&deg;' . $rollover['n_operacion'];
                                    } else {
                            ...
                            <table>
                                ...
                                <script>
                                    ...
                                    $(window).load(function(){
                                        ...
                                        tot_act_pn = (parseFloat(otr_act_pn) + parseFloat(utl_neta_pn) + parseFloat(act_fij_pn) + parseFloat(act_cir_pn) + parseFloat(ing_netos_pn)).toFixed(2);
