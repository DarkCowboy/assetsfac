                            ...
                            <tr>
                                <td class="segunda_columna" valign="top">
                                    <div class="contenedor_formulario">
                                        ...
                                        <form novalidate="novalidate" action="./bancos/consulta_movimientos" id="BusquedaCuentaBuscarForm" method="post" accept-charset="iso-8859-1">
                                        ...
                                        <? if ($reporte) { ?>
                                            <hr>
                                            <div style="margin: 0px auto; width: 613px;">
                                                <div class="top-bar">
                                                    <br>
                                                                ...
                                                                <? } else { ?>
                                                                    ...
                                                                    <td class="first style2 separador" style="text-align: center">
                                                                        <? if ($row['id_t_operacion'] == '1' || $row['id_t_operacion'] == '2') { ?>
                                                                            <a onclick="$.fancybox({type: 'iframe', 'padding': 0, 'autoSize': false, 'width': 730, 'height': 460, href: './egresos/ver_operacion/<?= sha1($row['id_instruccion']) ?>'});"
                                                                               href="#" >
                                                                                   <?= $row['n_cheque']; ?>
                                                                            </a>
                                                                        <? } elseif ($row['id_t_operacion'] == '3' and $row['detalles_concepto'] != 'Saldo de Inicio de Cuenta') { ?>
                                                                            <a onclick="$.fancybox({type: 'iframe', 'padding': 0, 'autoSize': false, 'width': 730, 'height': 460, href: './ingresos/ver_operacion/<?= sha1($row['id_instruccion']) ?>'});"
                                                                               href="#" >
                                                                                   <?= $row['n_cheque']; ?>
                                                                            </a>
                                                                        <? } ?>
                                                                    </td>                                
                                                                    <td class="first style2 separador" style="text-align: center"><?= $row['detalles_concepto']; ?></td>                                
