                            ...
                            <tr>
                                <td class="segunda_columna" valign="top">
                                    <div class="contenedor_formulario">
                                        ...
                                        <form novalidate="novalidate" action="./bancos/busqueda_movimientos" id="BusquedaCuentaBuscarForm" method="post" accept-charset="iso-8859-1">
                                            ...
                                            <table class="formulario" align="center" border="0" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="campo">
                                                            <select name="id_banco" class="combinacion valid" id="Busquedabanco">
                                                                <? foreach ($lista_bancos as $row) { ?>
                                                                    <option value="<?= $row['id_banco']; ?>"><?= $row['nombre_banco'] ?></option>
                                                                <? } ?>
                                                            </select>
                                                        </td>
                                                    </tr>
                                        ...
                                        <? if ($reporte) { ?>
                                            <div class="top-bar">
                                                <h1 style="text-align: center;">Movimientos <?= $titulo_reporte ?></h1>
                                            </div><br>
                                            <table style="margin-bottom: 10px; width: 93%;">
                                                <tr>
                                                    <td style="text-align: center;">Saldo inicio de Mes</td>
                                                    <td style="text-align: left;"><?= $corte_mes_anterior['saldo'] ?></td>
                                                    <td style="text-align: center; border-left: solid 1px black;">Saldo final de Mes</td>
                                                    <td style="text-align: left;"><?= $corte_mes_actual['saldo'] ?></td>
                                                </tr>
                                            </table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <? foreach ($reporte as $row) { ?> 
                                                        <tr>
                                                            ...
                                                            <td class="first style2 separador" style="text-align: center"><?= $row['Concepto_pago']; ?></td>                                
                                                            <td class="first style2 separador" style="text-align: right"><?= $row['id_t_operacion'] == 3 ? number_format($row['total_monto_pagar'], 2, ',', '.') : ''; ?></td>                                
                                                            <td class="first style2 separador" style="text-align: right"><?= $row['id_t_operacion'] == 1 ? number_format($row['total_monto_pagar'], 2, ',', '.') : ''; ?></td> 
                                                            <?
                                                            if ($row['id_t_operacion'] == 3) {
                                                                $saldo = $saldo + $row['total_monto_pagar'];
                                                            } else if ($row['id_t_operacion'] == 1) {
                                                                $saldo = $saldo - $row['total_monto_pagar'];
                                                            }
                                                            ?>
