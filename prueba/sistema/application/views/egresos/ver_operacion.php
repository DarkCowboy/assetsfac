                ...
                <div id="center-column"  class="mi_vista_clasica" style="float: left; margin: 0 auto; width: 704px !important; min-height: 0 !important;">
                    ...
                    <? if ($instruccion['t_instrumento'] == 'Cheque') { ?>
                        <? if ($instruccion['nombre_imagen_cheque']) { ?>
                            ...
                            <? } elseif (eregi('credicorp', strtolower(trim($instruccion['nombre_banco'])))) { ?>
                            ...
                            <tbody style="text-align: center;">
                                ...
                                <tr>
                                    <td colspan="3" rowspan="6" style="border: 1px solid black; text-align: justify; vertical-align: text-top; padding: 5px;">
                                        <?= 'Beneficiario: '.ucwords($instruccion['nombre_proveedor']) . '<br/> Detalles del concepto: ' . $instruccion['detalles_concepto'] . ' <br/> Soporte: ' . $instruccion['t_documento'] . ' <br/> N&deg; de cheque: ' . $instruccion['n_cheque'] ?>
                                    </td>
                    ...
                    <? } else if ($instruccion['t_instrumento'] == 'Transferencia') { ?>
                        <table style="width: 618px; margin: 0 auto;">
                            ...
                            <tbody style="text-align: center;">
                                ...
                                <tr>
                                    <td colspan="3" rowspan="6" style="border: 1px solid black; text-align: justify; vertical-align: text-top; padding: 5px;">
                                        <?= 'Detalles del concepto: ' . $instruccion['detalles_concepto'] . ' <br/> Soporte: ' . $instruccion['t_documento'] . ' <br/> N&deg; trasfrencia: ' . $instruccion['n_cheque'] ?>
                                    </td>
                                    <td style="border: 1px solid black; text-align: right;"><?= number_format($instruccion['total_monto_pagar'], 2, ',', '.'); ?></td>
                                </tr>
                                <tr>
    ...
    <!--                                <td style="width: 50%; text-align: center;">
        ...
        <? } ?>\n\
                                    ...
                                    <tr class="bg">
                                        ...
                                        <td class="last"><input name="t_documento" value="<?= $instruccion['t_documento'] ?>"  class="text imput_form1" type="text" data-required="true"></td>
                                    </tr>
                                    <tr class="bg">
