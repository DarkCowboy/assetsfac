...
<? } ?>\n\
                ...
                $('#beneficiario').append('\n\
                        ...
                        <tr class="bg">
                            ...
                            <td class="last"><input name="t_documento" id="email" class="text imput_form1" type="text" data-required="true"></td>
                        </tr>
                        <input name="fecha_pago" readonly="readonly" class="text imput_form1" type="hidden" value="<?= date('Y-m-d'); ?>" data-required="true">
                        <tr class="bg">
