...
class Consulta_Movimientos extends MY_Controller {

    private $data = array();

    public function __construct() {
        parent::__construct(array('bancos_model'), array(1, 2, 3, 10, 0));
        $this->data['menu'] = 'bancos';
        $this->data['sub_menu'] = 'consulta_movimientos';
    }
            ...
            if ($this->input->post()) {
                ...
                switch ($form['periodo']) {
                    case 'o': //Otro
                        ...
                        $form['query'] = ' instrucciones.id_banco = ' . $id_banco . ' and DATE(fecha_pago) BETWEEN \'' . $form['desde'] . '\' AND \'' . $form['hasta'] . '\' ';
                    ...
                    case 'a': //Mes actual
                        ...
                        $form['query'] = " instrucciones.id_banco = " . $id_banco . " and Date_format( fecha_pago, '%m' ) = Date_format( NOW( ) , '%m' )";
                        $this->data['reporte'] = $this->bancos_model->busqueda_avanzada($form);
                    ...
                    case 'n': //Mes anterior
                        ...
                        $form['query'] = " instrucciones.id_banco = " . $id_banco . " and Date_format( fecha_pago, '%m' ) = Date_format( DATE_SUB( NOW( ) , INTERVAL 1 MONTH ) , '%m' )";
                        $this->data['reporte'] = $this->bancos_model->busqueda_avanzada($form);
                    ...
                    case 'u': //Últimos 12 meses
                        $form['query'] = ' instrucciones.id_banco = ' . $id_banco . ' and `fecha_pago` BETWEEN DATE_SUB( NOW( ) , INTERVAL 12 MONTH ) AND NOW( )';
                        $this->data['reporte'] = $this->bancos_model->busqueda_avanzada($form);
...
//                        debug($row);
            ...
            $this->load->view('bancos/consulta_movimientos', $this->data);
        }
    }
