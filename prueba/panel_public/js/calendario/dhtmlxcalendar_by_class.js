function dhtmlXCalendarObject(inps, skin) {
	...
	if (typeof(inps) == "string") {
		var t0 = document.querySelectorAll(inps);
	} else {
		var t0 = inps;
	}
                console.debug(t0);
	...
	for (var q=0; q<inps.length; q++) {
		if (typeof(inps[q]) == "string") inps[q] = (document.querySelectorAll(inps[q])||null);
...
/*=============================================== incluir en ready del html JGil *//*
$(function(){
	
	myCalendar = new dhtmlXCalendarObject(["cuandoempezar"]);
