                    ...
                    <div class="block-fluid">                        
                        ...
                        <div class="row-form">
                            <div class="span5"><a target="_blank" href="./Formato de Facturas ASSETS.xlsm" title="Formato de Facturas"><b>Descargue aqui</b></a> y guarde en <b>Escritorio o Documentos</b> (OPCIONAL / RECOMENDADO) el Formato 
                                Para realizar la carga de las facturas y <b>convertirlas a CSV</b>; una vez creado el archivo con el formato CSV ingrese en esta seccion y presione el boton "<b>Seleccione el archivo</b>" busque la ubicacion del CSV en su computador y por ultimo presione en "<b>CARGAR FACTURA</b>"</div>
                            <div class="span7" style="float: right; display: block;float: right; margin-top: 27px; position: relative; right: 13%; width: 328px;">   
                                <form action='./facturas/cargar_facturas/' method='post' enctype="multipart/form-data" id="facturas_file">
            ...
            <div class="row-fluid">
                <div class="span12">                    
                    ...
                    <div class="block-fluid table-sorting">
                        <form action="./facturas/guardar_lote" method="post" id="validate-form" id="validate-form" autocomplete="off" onSubmit="return valida(this);" >
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;"  width="10%">RUC / RIF</th>
...
<!--                                        <th style="text-align: center;"  width="2%">ITBMS(%)</th>
                                ...
                                <tbody class="body_tablas_facturas">
                                    ...
                                    if (isset($faturas)) {
                                        foreach ($faturas as $row) {
                                            ?>
                                            <tr>
                                                <td  style="text-align: center;" ><span class="eli" style="cursor: pointer; display: block; margin: 0 auto;"><img src="img/icons/bs/ic_cancel.png" title="Eliminar Factura">  Eliminar</span></td>
                                                <td  style="text-align: center;" ><input value="<?= $row['numero_factura'] ?>" type="text" name="numero_factura[]" data-required="true" style="width: 82% !important;text-align: center;" /></td>
                                                ...
                                                <td  style="text-align: center;" ><input value="<?= $row['fecha_emision'] ?>"  placeholder="dd-mm-yyyy" name="fecha_emision[]" data-required="false,fecha" style="width: 90% !important;text-align: left;"/></td>
                                                <td  style="text-align: center;" ><input value="<?= $row['fecha_vencimiento'] ?>"  placeholder="dd-mm-yyyy" type="date" name="fecha_vencimiento[]" data-required="false,fecha" style="width: 90% !important;text-align: left;"/></td>
                                                <? if ($formato) { ?>
        ...
        <!--                                                <td  style="text-align: center;" >
                                                ...
                                                <!--<td  style="text-align: center;" >-->
                                        <!--<input hidden="hidden" value="<?= $valor_con_iva ?>" class="valor_con_iva" readonly="readonly" data-required="true" onkeypress="return permite(event, 'numpunto')" type="text" name="valor_con_iva[]" style="width: 82% !important;text-align: center;"/>-->
                            <!--</td>-->                                    
                                        <!--</tr>-->
                                    <? }
                                    ?>
                                <? }
                                ?>
                                <input name="result_iva_input" id="result_iva_input" type="hidden"/>
                                <input name="result_nominal_input" id="result_nominal_input" type="hidden"/>
                                <tr>
    ...
    <script>
        $(window).load(function () {
            ...
            $('.valor_nominal').each(function () {
                ...
                $('#result_nominal_input').val(totalvalor_nominal.toFixed(2));
            });
            ...
            $('#id_add_nueva').click(function () {
                document.title = '';
                var cuerpo = '<tr><td  style="text-align: center;" ><span class="eli" style="cursor: pointer; display: block; margin: 0 auto;"><img src="img/icons/bs/ic_cancel.png" title="Eliminar Factura">  Eliminar</span></td>' + document.title;
                cuerpo += '<td  style="text-align: center;" ><input type="text" name="numero_factura[]" data-required="true" style="width: 82% !important;text-align: center;" /></td>' + document.title;
                ...
                cuerpo += '<td  style="text-align: center;" ><input type="date"  class="datepicker_multi_start" name="fecha_emision[]" data-required="false,fecha"  style="width: 90% !important;text-align: left;"/></td>' + document.title;
                cuerpo += '<td  style="text-align: center;" ><input type="date"  class="datepicker_multi_start" name="fecha_vencimiento[]" data-required="false,fecha"  style="width: 90% !important;text-align: left;"/></td>' + document.title;
        ...
        function valida(form) {
            ...
            z = $("#validate-form").find("input").length;
            if (z <= 3) {
